...
img_title = img_soup.find_all('h3')[0].get_text()
img_title
...
img_text = img_soup.find_all('a', class_='itemLink product-item')[0].get('href')
img_text
# img_page = browser.find_by_text(img_text)
# img_page.click()
# browser.find_by_css('img.thumb').click()
#browser.links.find_by_partial_text('cerberus').click()
#browser.links.find_by_href('https://marshemispheres.com/cerberus.html').click()
# browser.links.find_by_text(f'https://marshemispheres.com/{img_text}').click()
